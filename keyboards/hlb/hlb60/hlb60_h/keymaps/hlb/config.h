...
#define VIAL_KEYBOARD_UID {0x63, 0x1C, 0x77, 0xCB, 0x2B, 0x49, 0xED, 0x85}
...
#define RGB_BLINK_ARR_SIZE 6
#define RGB_BLINK_DURATION 2000
#define RGB_BLINK_FAST_PERIOD_MS  100
